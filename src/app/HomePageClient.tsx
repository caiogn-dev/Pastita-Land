      ...
      <section className="relative w-full h-[80vh] min-h-[600px] flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <div className="relative z-20 container px-4 md:px-6 flex flex-col items-center space-y-6">
          ...
          <Button
            asChild
            size="lg"
            onClick={() => track('cta_click', { button_name: 'Peça Agora no Anota.ai Hero' })}
          ...
          <div className="mx-auto w-full max-w-6xl grid grid-cols-1 md:grid-cols-3 gap-8 py-12">
            <Card className="border-secondary hover:border-accent hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
              ...
              <CardContent className="p-6">
                ...
                <CardDescription className="mt-2 text-base">Deliciosos rondellis recheados com os melhores e mais frescos ingredientes.</CardDescription>
              </CardContent>
            </Card>
            <Card className="border-secondary hover:border-accent hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
               <CardHeader className="p-0">
               ...
               <CardContent className="p-6">
                ...
                <CardDescription className="mt-2 text-base">Saborosas e suculentas iscas de carne para acompanhar sua massa preferida.</CardDescription>
              </CardContent>
            </Card>
            <Card className="border-secondary hover:border-accent hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
               <CardHeader className="p-0">
               ...
               <CardContent className="p-6">
                ...
                <CardDescription className="mt-2 text-base">Nossa variedade de molhos artesanais para complementar e enriquecer seu prato.</CardDescription>
              </CardContent>
            </Card>
          </div>
           <div className="flex justify-center mt-8">
              <Button 
                asChild 
                size="lg" 
                onClick={() => track('cta_click', { button_name: 'Ver Cardápio Completo' })}
